...
import com.test.api.marvel_challenge.services.CharacterService;
...
public class CharacterController {
    ...
    public ResponseEntity<CharacterDto.CharacterInfoDto> findInforById(@PathVariable Long characterId){
